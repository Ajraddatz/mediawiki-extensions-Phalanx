...
$messages['qqq'] = array(
	...
	'phalanx-display-row-blocks' => '$1 is the filter type, one or more of the following (comma-separated if multiple): [[MediaWiki:Phalanx-type-content]], [[MediaWiki:Phalanx-type-summary]], [[MediaWiki:Phalanx-type-title]], [[MediaWiki:Phalanx-type-user]], [[MediaWiki:Phalanx-type-user-email]], [[MediaWiki:Phalanx-type-answers-question-title]], [[MediaWiki:Phalanx-type-answers-recent-questions]], [[MediaWiki:Phalanx-type-wiki-creation]',
...
* $1 is the filter type, such as "content" ([[MediaWiki:Phalanx-type-content]])
...
* $5 is [[MediaWiki:Phalanx-link-stats]], containing a link to ''Special:PhalanxStats/$3''",
	...
	'phalanx-rule-log-details' => 'Part of log entries ([[MediaWiki:Phalanx-rule-log-add]], [[MediaWiki:Phalanx-rule-log-edit]], [[MediaWiki:Phalanx-rule-log-delete]]).
...
* $3 is the user-supplied reason why this is being blocked',
	'action-phalanx' => 'Shown if someone without the <code>phalanx</code> user right tries to access Phalanx special pages; used as a part of [[MediaWiki:Permissionserrorstext-withaction]]',
	'right-phalanx' => 'Shown on Special:ListGroupRights',
	'right-phalanxexempt' => 'Shown on Special:ListGroupRights',
	'right-phalanxemailblock' => 'Shown on Special:ListGroupRights',
);
 ...
 */
$messages['de'] = array(
	'phalanx' => 'Phalanx – Integrierter Spam-Verteidigungs-Mechanismus',
	'phalanx-desc' => 'Phalanx ist ein integrierter Spam-Verteidigungs-Mechanismus',
	'phalanx-ui-description' => 'Spamverteidigungsmechanismus-Verwaltungsoberfläche',
...
Anmerkung: funktioniert nur für Wikis vom Typ Answers.',
	...
	'phalanx-user-block-reason-ip' => 'Aufgrund von Vandalismus oder anderem Fehlverhalten durch dich oder jemanden, der deine IP-Adresse mitnutzt, wurde dieser IP-Adresse das Schreibrecht entzogen. Dies gilt für das gesamte Netzwerk.
Wenn du denkst, dass es sich hierbei um einen Fehler handelt, [[Special:Contact|kontaktieren Sie uns]]!',
	'phalanx-user-block-reason-exact' => 'Diesem Benutzernamen oder dieser IP-Adresse ist das Schreiben – aufgrund von Vandalismus oder anderem Fehlverhalten – im gesamten Netzwerk verboten worden.
Wenn du denkst, dass es sich hierbei um einen Fehler handelt, dann [[Special:Contact|kontaktieren Sie uns]]!',
	'phalanx-user-block-reason-similar' => 'Aufgrund von Ähnlichkeit mit dem Benutzernamen eines für Vandalismus oder anderes Fehlverhalten gesperrten Benutzers wurde auch diesem Benutzerkonto das Schreibrecht im gesamten Netzwerk entzogen.
Bitte [[Special:Contact|kontaktieren Sie uns]] im Falle eines Versehens!',
	'phalanx-user-block-withreason-ip' => 'Aufgrund von Vandalismus oder anderem Fehlverhalten durch dich oder jemanden, der deine IP-Adresse mitnutzt, wurde dieser IP-Adresse das Schreibrecht entzogen. Dies gilt für das gesamte Netzwerk.
Wenn du denkst, dass es sich hierbei um einen Fehler handelt, [[Special:Contact|kontaktieren Sie uns]]!<br />Als Sperrgrund wurde Folgendes angegeben: $1',
	'phalanx-user-block-withreason-exact' => 'Diesem Benutzernamen oder dieser IP-Adresse ist das Schreiben – aufgrund von Vandalismus oder anderem Fehlverhalten – im gesamten Netzwerk verboten worden.
Wenn du denkst, dass es sich hierbei um einen Fehler handelt, dann [[Special:Contact|kontaktieren Sie uns]]!<br />Als Sperrgrund wurde Folgendes angegeben: $1',
	'phalanx-user-block-withreason-similar' => 'Aufgrund von Ähnlichkeit mit dem Benutzernamen eines für Vandalismus oder anderes Fehlverhalten gesperrten Benutzers wurde auch diesem Benutzerkonto das Schreibrecht im gesamten Netzwerk entzogen.
Bitte [[Special:Contact|kontaktieren Sie uns]] im Falle eines Versehens!<br />Als Sperrgrund wurde Folgendes angegeben: $1',
	'phalanx-blacklisted-email' => 'Schwarzgelistete E-Mail-Adresse',
	'phalanx-blacklisted-email-text' => 'Deine E-Mail-Adresse ist derzeit auf der schwarzen Liste zum Versenden von E-Mails an andere Benutzer.',
	...
	'phalanx-no-matches' => 'Keine Treffer.',
	...
	'action-phalanx' => 'den integrierten Spam-Verteidigungs-Mechanismus zu verwenden.',
...
$messages['fi'] = array(
	...
	'phalanx-view-id' => 'Hae suodatin ID:n perusteella:',
	...
	'phalanx-format-case' => 'merkkikokoriippuvainen',
...
[[Special:Contact|Ota meihin yhteyttä]] tästä ongelmasta.<br />Eston tekijä antoi myös tämän lisäsyyn: $1.',
	'phalanx-blacklisted-email' => 'Mustalistattu sähköpostiosoite',
	...
	'phalanx-title-move-summary' => 'Antamasi syy sisälsi estetyn lausekkeen',
	'phalanx-plain-text' => 'pelkkä teksti',
	...
	'phalanx-stats-table-create' => 'Luomisaika',
	'phalanx-stats-table-expire' => 'Päättymisaika',
	'phalanx-stats-table-exact' => 'Täsmälleen',
	'phalanx-stats-table-regex' => 'Säännöllinen lauseke',
	'phalanx-stats-table-case' => 'Kirjainkokoriippuvainen',
	...
	'phalanx-stats-table-wiki-url' => 'Wikin URL',
	...
	'right-phalanx' => 'Lisätä, muokata ja poistaa erilaisia spämmisuodattimia',
	'right-phalanxexempt' => 'Erivapaus Phalanx-spämmisuodattimesta',
	'right-phalanxemailblock' => 'Voi luoda, katsoa ja hallita sähköpostipohjaisia estoja',
);
...
$messages['nl'] = array(
	...
	'phalanx-type-content' => 'artikel inhoud',
	'phalanx-type-summary' => 'artikel samenvatting',
	'phalanx-type-title' => 'artikel titel',
	'phalanx-type-user' => 'gebruiker',
	'phalanx-type-user-email' => 'e-mail',
	'phalanx-type-answers-question-title' => 'vraag titel',
	'phalanx-type-answers-recent-questions' => 'recente vragen',
	'phalanx-type-wiki-creation' => 'wiki creatie',
	'phalanx-add-block' => 'Blokkade toepassen',
	'phalanx-edit-block' => 'Sla blokkade op',
	'phalanx-label-filter' => 'Filter:',
	'phalanx-label-reason' => 'Rede:',
	'phalanx-label-expiry' => 'Verloop:',
	'phalanx-label-type' => 'Type:',
	'phalanx-label-lang' => 'Taal:',
	'phalanx-view-type' => 'Type blokkade...',
	'phalanx-view-blocker' => 'Zoek op filter tekst:',
	'phalanx-view-blocks' => 'Doorzoek filters',
	'phalanx-view-id' => 'Verkrijg filter per ID:',
	'phalanx-view-id-submit' => 'Verkrijg filter',
	...
	'phalanx-format-text' => 'onopgemaakte tekst',
	'phalanx-format-regex' => 'regex',
	'phalanx-format-case' => 'hoofdlettergevoelig',
	'phalanx-format-exact' => 'precies',
	'phalanx-tab-main' => 'Beheer filters',
	'phalanx-tab-secondary' => 'Test filters',
	'phalanx-block-success' => 'De blokkade is succesvol toegevoegd',
	'phalanx-block-failure' => 'Er trad een fout op bij het toevoegen van de blokkade',
	'phalanx-modify-success' => 'De blokkade was succesvol gewijzigd',
	'phalanx-modify-failure' => 'Er was een fout bij het wijzigen van de blokkade',
	'phalanx-modify-warning' => 'JE BEWERKT BLOKKADE #$1. OP TOEPASSEN KLIKKEN SLAAT JE WIJZIGINGEN OP!',
	'phalanx-test-description' => 'Door test voorziene tekst tegen huidige blokkades.',
	'phalanx-test-submit' => 'Test',
	'phalanx-content-spam-summary' => 'De tekst was gevonden in de samenvatting van de pagina.',
	'phalanx-link-unblock' => 'deblokkeer',
	'phalanx-link-modify' => 'wijzig',
	'phalanx-link-stats' => 'statistieken',
	'phalanx-reset-form' => 'Reset formulier',
	'phalanx-legend-input' => 'Maak of wijzig filter',
	'phalanx-legend-listing' => 'Momenteel werkende filters',
	'phalanx-unblock-message' => 'Blokkade ID #$1 was succesvol verwijderd',
	'phalanx-help-type-content' => 'Deze filter weerhoudt een pagina ervan om opgeslagen te worden, als zijn inhoud een van de zinnen bevat die op de zwarte lijst staan.',
	'phalanx-help-type-summary' => 'Deze filter weerhoudt een bewerking ervan opgeslagen te worden, als de gegeven samenvatting overeenkomt met een van de woorden die op de zwarte lijst staan.',
	'phalanx-help-type-title' => 'Deze filter weerhoudt een pagina ervan om gecreëerd te worden, alz ijn titel overeenkomt met een van de zinnen die op de zwarte lijst staan.

Als weerhoudt een al bestaande pagina er niet van om bewerkt te worden.',
	'phalanx-help-type-user' => 'Deze filter blokkeert een gebruiker (precies hetzelfde als een locale MediaWiki blokkade), als de gebruikersnaam een van de woorden of IPs bevat die op de zwarte lijst staan.',
	'phalanx-help-type-wiki-creation' => 'Deze filter weerhoudt een wiki ervan om gecreëerd te worden, als de naam of URL een woord bevat die op de blacklist staat.',
	'phalanx-help-type-answers-question-title' => "Deze filter weerhoudt een vraag (pagina) om gecreëerd te worden, als de titel overeenkomt met een van de zinnen op de zwarte lijst.

Note: Werkt alleen op Antwoord-type wiki's",
	'phalanx-help-type-answers-recent-questions' => "Deze filter weerhoudt vragen (pagina's) van weergeven te worden in een aantal outputs (widgets, lijsten, tag-gegenereerde lijsten). Het weerhoudt die artikels niet om gemaakt te worden.
...
Note: Werkt alleen op Antwoord-type wiki's",
	...
	'phalanx-user-block-reason-ip' => 'Dit IP adres wordt ervan weerhouden om te bewerken in verband met vandalisme of andere overtredingen door jou of iemand die jouw IP adres deelt. Als je denkt dat dit een fout was, [[Special:Contact|neem dan a.u.b contact met ons op]].',
	'phalanx-user-block-reason-exact' => 'Deze gebruikersnaam wordt ervan weerhouden om te bewerken in verband met vandalisme of andere overtredingen. Als je denkt dat dit een fout was, [[Special:Contact|neem dan a.u.b contact met ons op]].',
	'phalanx-user-block-reason-similar' => 'Deze gebruikersnaam wordt ervan weerhouden om te bewerken in verband met vandalisme of andere overtredingen door een gebruiker met een soortgelijke naam. Maak a.u.b. een alternatieve gebruikersnaam of [[Special:Contact|neem contact met ons op]] over het probleem.',
...
Kies een andere gebruikersnaam of [[Special:Contact|neem contact met ons op]] over het probleem.<br />De reden voor blokkeren is: $1.',
	...
	'phalanx-title-move-summary' => 'De rede die je ingevoerd hebt bevat een geblokkeerde zin.',
	'phalanx-plain-text' => 'onopgemaakte tekst',
	'phalanx-list-regex' => 'regex',
	'phalanx-display-row-blocks' => 'blokkades: $1',
	'phalanx-display-row-created' => 'gecreëerd door [[User:$1|$1]] op $2',
	'phalanx-test-results-legend' => 'Test resultaten',
	'phalanx-no-matches' => 'Niets gevonden.',
	'phalanxstats' => 'Phalanx statistieken',
	'phalanx-email-filter-hidden' => 'E-mailfilter verborgen. U hebt geen rechten om de tekst te bekijken.',
	'phalanx-yes' => 'Ja',
	'phalanx-no' => 'Nee',
	'phalanx-stats-table-id' => 'Blokkeer ID',
	'phalanx-stats-table-user' => 'toegevoegd door',
	'phalanx-stats-table-type' => 'Type',
	'phalanx-stats-table-text' => 'Tekst',
	'phalanx-stats-table-create' => 'gecreëerd op',
	'phalanx-stats-table-expire' => 'verloopt op',
	...
	'phalanx-stats-block-notfound' => 'Block ID niet gevonden',
	'phalanx-stats-table-wiki-id' => 'Wiki-ID',
