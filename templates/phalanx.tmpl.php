...
<div id="phalanx-mainframe">
	<div class="phalanx-tabs" id="phalanx-nav-area">
		<ul>
			<li class="phalanx-accent selected" id="phalanx-main-tab"><a href="#main"><?php echo wfMsg( 'phalanx-tab-main' ) ?></a></li>
			<li class="phalanx-accent" id="phalanx-test-tab"><a href="#test"><?php echo wfMsg( 'phalanx-tab-secondary' ) ?></a></li>
		</ul>
	</div>
						...
						<div class="clearfix">
							...
							<div id="phalanx-block-types" class="phalanx-block-types">
								<div>
									...
									<label for="wpPhalanxTypeSummary"><?php echo wfMsg( 'phalanx-type-summary' ) ?></label>								</div>
								<div>
									<?php echo Xml::check( 'wpPhalanxType[]', !empty( $this->data['data']['type'][4] ), array( 'id' => 'wpPhalanxTypeTitle', 'value' => 4 ) ) ?>
									<label for="wpPhalanxTypeTitle"><?php echo wfMsg( 'phalanx-type-title' ) ?></label>								</div>
								<div>
							...
							<div id="phalanx-help">
								<div id="phalanx-help-1" class="phalanx-accent"><?php echo wfMsg( 'phalanx-help-type-content' ) ?></div>
								<div id="phalanx-help-2" class="phalanx-accent"><?php echo wfMsg( 'phalanx-help-type-summary' ) ?></div>
								<div id="phalanx-help-4" class="phalanx-accent"><?php echo wfMsg( 'phalanx-help-type-title' ) ?></div>
								<div id="phalanx-help-8" class="phalanx-accent"><?php echo wfMsg( 'phalanx-help-type-user' ) ?></div>
								<!--<div id="phalanx-help-64" class="phalanx-accent"><?php echo wfMsg( 'phalanx-help-type-wiki-creation' )  ?></div>
								<div id="phalanx-help-16" class="phalanx-accent"><?php echo wfMsg( 'phalanx-help-type-answers-question-title' ) ?></div>
								<div id="phalanx-help-32" class="phalanx-accent"><?php echo wfMsg( 'phalanx-help-type-answers-recent-questions' ) ?></div>-->
								<div id="phalanx-help-256" class="phalanx-accent"><?php echo wfMsg( 'phalanx-help-type-user-email' ) ?></div>
							</div>
						</div>
						<!-- Reason -->
